...
#class AbinitNcFile(BaseFile, metaclass=abc.ABCMeta):
    ...
    def get_input_string(self) -> str:
        ...
        Only nc files generated by Abinit9 have this variable.
        """
...
class HasNotebookTools:
    ...
    def make_and_open_notebook(self, nbpath=None, foreground=False,
        ...
        Args:
            nbpath: If nbpath is None, a temporaty file is created.
...
class NotebookWriter(HasNotebookTools, metaclass=abc.ABCMeta):
    ...
    def write_notebook(self, nbpath=None) -> str:
        """
        Write a jupyter_ notebook to nbpath. If nbpath is None, a temporaty file is created.
