...
class WorkerClient(MSONable):
    ...
    def __init__(self, worker_state, is_default_worker=False, timeout=240,
        ...
        self.saved_uuid = saved_uuid if saved_uuid is not None else self.worker_state.uuid
    ...
    @need_serving_worker
    def send_pyscript(self, filepath, end_point="post_flow_script"):
        """
    ...
    @need_serving_worker
    def send_flow_dirs(self, flow_dirs, end_point="post_flow_dirs"):
        ...
        url = f"{self.server_url}/{end_point}"
        print(f"Sending `{flow_dirs} directories to {self.worker_state.name} worker at url: {url} ...\n")
        self.check_server_url()
    ...
    def open_webgui(self):
        url = self.server_url
        print(f"Sending request to {self.worker_state.name} worker at url: {url} ...\n")
        self.check_server_url()
