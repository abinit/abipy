...
class PadeTest(AbipyTest):
    def test_sigma_pade(self):
        ...
        f_zs = np.array(
            [
                (-3.4591316381250774 - 0.09890936491537991j),
                (-3.4538645067311458 - 0.24793469903457657j),
                (-3.4173978321863663 - 0.6621397224074206j),
                (-3.257949585597619 - 1.324699039193591j),
                (-2.523177170083569 - 2.4583423787866163j),
                (-0.8792031880464662 - 2.2566436943461583j),
            ],
            dtype=complex,
        )
        ...
        ref_f = [
            -3.36245542 + 0.0371258j,
            -3.38196076 + 0.03677179j,
            -3.40149899 + 0.036502j,
            -3.42108152 + 0.03632633j,
        ]
        self.assert_almost_equal(this_f, ref_f, decimal=7)
        ref_fp = [
            -0.19492091 - 0.00392504j,
            -0.19520083 - 0.00313668j,
            -0.19558294 - 0.00224237j,
            -0.1960902 - 0.00125779j,
        ]
