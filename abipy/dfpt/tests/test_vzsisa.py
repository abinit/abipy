...
class QhaTest(AbipyTest):
    def test_vzsisa(self):
        ...
        self.assert_almost_equal(
            data.tot_en,
            [[-230.27531394], [-230.28382933], [-230.28659309], [-230.28404059], [-230.27657594], [-230.26457428]],
        )
        ...
        self.assert_almost_equal(
            f.values,
            [-0.0000000e00, 5.1944952e-07, 7.0431284e-06, 9.4401141e-06, 1.0630764e-05, 1.1414897e-05, 1.2035432e-05],
        )
        ...
        self.assert_almost_equal(alphas, [60.0, 60.0])
        self.assert_almost_equal(betas, [60.0, 60.0])
        self.assert_almost_equal(gammas, [60.0, 60.0])
        ...
        self.assert_almost_equal(alphas, [-0.0000000e00, 4.6240312e-06, 9.4381513e-06, 1.1048456e-05, 1.2028183e-05])
        ...
        self.assert_almost_equal(data.tmesh, [0.0, 1000.0])
        self.assert_almost_equal(
            data.cv, [[0.0, 0.00050313], [0.0, 0.0005035], [0.0, 0.00050386], [0.0, 0.0005042], [0.0, 0.00050453]]
        )

        self.assert_almost_equal(data.free_energy[0], [0.12305556, -0.45237198])
        self.assert_almost_equal(data.entropy[0], [0.0, 0.0009788])
