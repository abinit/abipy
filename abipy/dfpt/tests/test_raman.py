...
class RamanTest(AbipyTest):
    ...
    def test_raman(self):
        ...
        self.assert_equal(im.shape, (6, 3, 3))
        self.assert_almost_equal(im[3, 0, 1], 0.03668238755672564)
        ...
        self.assert_equal(pi.perp.shape, (6,))
        self.assert_almost_equal(pi.tot[5], 1)
