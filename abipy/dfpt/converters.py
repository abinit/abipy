...
def phonopy_to_abinit(unit_cell=None,
    ...
    # DDB version > 20240201 contains an additional line with the frequency of the perturbation
    # This feature is not not supported in add_data_ddb and ddb.write.
    # To bypass this problem, here we write the DDB using an old format without frequencies.
    if ddb.version >= 20240201:
        ddb.version = 20230401
