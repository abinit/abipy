...
def itest_phonon_flow(fwp, tvars):
    ...
    flow = flowapi.phonon_flow(fwp.workdir, scf_input, ph_inputs, manager=fwp.manager)
    ...
    ddb_path = flowapi.Mrgddb().merge(flow.outdir.path, ddb_files, out_ddb=out_ddb, 
    ...
    awork = flowapi.Work(manager=shell_manager)
    ...
    atask = flowapi.AnaddbTask(anaddb_input, ddb_node=ddb_path, manager=shell_manager)
