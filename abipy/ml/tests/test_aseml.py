...
class AbimlTest(AbipyTest):
    ...
    def test_mlvalidate(self):
        ...
        validator = aseml.MlValidateWithAbinitio(
            filepaths, nn_names="emt", traj_range=range(0, 5, 2), verbose=1, workdir=None, prefix=None
        )
