...
class TestWoutFile(AbipyTest):
    def test_example01_gaas(self):
        ...
        with abilab.abiopen(filepath) as wout:
            ...
            self.assert_almost_equal(
                wout.structure.frac_coords.ravel(), [0.00000, 0.00000, 0.00000, 0.25000, 0.25000, 0.25000]
            )
    ...
    def test_example03_silicon(self):
        ...
        with abilab.abiopen(filepath) as wout:
            ...
            self.assert_almost_equal(
                wout.structure.frac_coords.ravel(), [-0.25000, 0.75000, -0.25000, 0.00000, 0.00000, 0.00000]
            )
            assert not wout.warnings
