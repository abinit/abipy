...
epsh1="""\
lower energy limit for `phase-shift-like` log-derivative plots"
...
rlmax="""\
maximum radius for Abinit psp code 8 format output.  must be
...
ncnf="""\
number of test configurations (<=4)  The reference config is always
run first as a consistency check.  core always is the reference core configuration""",
)
