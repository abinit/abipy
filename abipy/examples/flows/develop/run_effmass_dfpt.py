...
Flow to compute effect masses with DFPT assuming the band edges are known.
"""
...
def build_flow(options):
    ...
    nspinor = 1
    scf_input = make_scf_input(nspinor=nspinor, usepaw=1)
    ...
    effmass_bands_f90 = [1, 4] if nspinor == 1 else [1, 8]
