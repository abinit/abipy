...
using the generalized Frohlich model. T
The flow uses DFPT to compute the effective masses at the band edges
(automatically detected by performing a NSCF run with a k-path),
