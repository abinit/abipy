...
def build_flow(options):
    ...
    chi_ppm_input = scf_input.new_with_vars(
        optdriver=3,
        ecuteps=ecuteps,
        nband=nband,
    )

    sigma_ppm_input = chi_ppm_input.new_with_vars(
        optdriver=4,
    ...
    if use_ac:
        ...
        for gwr_ntau in gwr_ntau_list:
            chi_ac_input = scf_input.new_with_vars(
                optdriver=3,
            ...
            sigma_ac_input = chi_ac_input.new_with_vars(
                optdriver=4,
                nomegasi=gwr_ntau,
    ...
    if use_cd:
        ...
        chi_cd_input = scf_input.new_with_vars(
            optdriver=3,
        ...
        sigma_cd_input = chi_cd_input.new_with_vars(
            optdriver=4,
            ecutsigx=gwr_template["ecutsigx"],
            # nfreqsp=200,
            # freqspmax=2.,
