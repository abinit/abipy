...
# %%
# Plot energies on k-path + DOS with plotly
ni_ebands_kpath.plotly_with_edos(ni_edos, ylims=elims, title="Ni band structure + DOS")
...
ni_ebands_kpath.boxplotly(brange=[5, 10], title="Boxplot for up and down spin and 10 > band >= 5")
