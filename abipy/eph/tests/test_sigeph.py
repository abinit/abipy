        ...
        with abilab.SigEPhRobot.from_files(filepaths) as robot:
            ...
            if self.has_matplotlib():
                ...
                assert robot.plot_qpdata_conv_skb(
                    spin=0, kpoint=(0, 0, 0), band=3, itemp=0, sortby="nbsum", hue="nqibz", show=False
                )

                # Test plot_qpfield_vs_e0
                assert robot.plot_qpfield_vs_e0(
                    "qpeme0", itemp=1, sortby=None, hue=None, colormap="viridis", show=False
                )
                assert robot.plot_qpfield_vs_e0(
                    "ze0", itemp=1, sortby="nbsum", hue="nqibz", colormap="viridis", show=False
                )
