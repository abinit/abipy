...
class SmearingTest(AbipyTest):
    def test_smearing_info(self):
        ...
        repr(sm); str(sm)
        self.assert_msonable(sm, test_if_subclass=False)
...
class EbandsReaderTest(AbipyTest):
    ...
    def test_reader(self):
        ...
        with ElectronsReader(abidata.ref_file("si_scf_WFK.nc")) as r:
            ...
            self.assert_msonable(smearing, test_if_subclass=False)
...
class ElectronBandsTest(AbipyTest):
    ...
    def test_nickel_ebands_spin(self):
        ...
        self.assert_msonable(ni_ebands_kpath, test_if_subclass=False)
        assert len(ni_ebands_kpath.to_json())

        self.assert_msonable(ni_ebands_kmesh, test_if_subclass=False)
    ...
    def test_silicon_ebands(self):
        ...
        self.assert_msonable(si_ebands_kmesh, test_if_subclass=False)
