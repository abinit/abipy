...
class DeltaSCFTest(AbipyTest):
    def test_deltaSCF(self):
        """Testing DeltaSCF"""
        Delta_333 = DeltaSCF.from_four_points_file(
            [
                abidata.ref_file("A_g_out_GSR.nc"),
        ...
        ## folding procedure
        ph_pristine = [
            ddb_ucell_to_phonopy_supercell(unit_ddb=ddb_pristine, nac=False) for ddb_pristine in ddb_pristine_s
        ]
        ...
        ph_emb_s = [
            Embedded_phonons.from_phonopy_instances(
                phonopy_pristine=ph,
        ...
        lineshapes = [
            Lineshape.from_phonopy_phonons(
                E_zpl=Delta_333.E_zpl(),
                phonopy_ph=ph,
                ...
                coords_defect_phonons=coords_defect_dSCF,
            )
            for ph in ph_emb_s
        ]
