...
4 0 0 0 4 0 0 0 4 is fine while kprtlatt = 1 0 0 0 1 1 0 -1 1 will not work.
...
a) Case nqshft=1 In general, 0.5 0.5 0.5 with the ngqpt's even will give very
economical grids. On the other hand, is it sometimes better for phonons to
...
b) Case nqshft=2 The two q1shft vectors must form a BCC lattice. For example,
use 0.0 0.0 0.0 and 0.5 0.5 0.5

c) Case nqshft=4 The four q1shft vectors must form a FCC lattice. For example,
use 0.0 0.0 0.0 , 0.0 0.5 0.5 , 0.5 0.0 0.5 , 0.5 0.5 0.0 or 0.5 0.5 0.5 , 0.0
0.0 0.5 , 0.0 0.5 0.0 , 0.5 0.0 0.0 (the latter is referred to as shifted)
...
Variable(
    ...
    text="""
If **relaxat** =1, relax lattice constants (lengths/angles) during a
...
Zacharias and Giustino (PRB 94 075125 (2016)). The displacements are chosen
...
electron phonon coupling. In this way in the PRB dielectric properties at
...
version, both eigenvalues (densergridGKK, obtained from mrggkk with only the
