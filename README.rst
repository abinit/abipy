...
See `later<#how-to-install-conda->`_ to install conda itself.
...
If you are using conda_ (see `later<#how-to-install-conda->`_ to install conda itself),  create a new environment (``abipy3.6``) based on python3.6 with::
